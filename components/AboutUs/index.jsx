      ...
      <DepartmentContainer>
        ...
        <SectionBody>
          <section>
            ...
            <p>
              This department is responsible for the day-to-day operations of an
              organization and also responsible for training IT/SIWES students
              and also computer illiterate.
            </p>
            <h3>SECTIONS</h3>
            <ol>
              <strong>
                <li>Cyber Café Section:</li>
              </strong>
              <figcaption>
                This section provides services to people who do not have access
                to computers and internet at home. Some of the services rendered
                are: internet access, computer rental, printing and scanning,
          ...
          <section>
            ...
            <p>
              This department is responsible for providing support to students
              who are struggling academically or personally.
            </p>
            <h3>SECTIONS</h3>
            <ol>
              <strong>
                <li>Counselling Section:</li>
              </strong>
              <figcaption>
                ...
                students explore their interest and values, help students
                identify their skills and strength, help students develop a
                career plan and also provide support and guidance in their
                choice of their career.
              </figcaption>{" "}
              <br />
              <strong>
                <li>Tutoring Section:</li>
              </strong>
              <figcaption>
                This section is responsible for providing experience and
                qualified tutors in a specific subject area, that would help
                students to succeed academically. They offer a variety of
                tutoring options, such as one-on-one tutoring, group tutoring
                and online tutoring, depending on the person’s budget.
              </figcaption>
            </ol>
          </section>
        </SectionBody>
